...
public class AuGatewayFilterFactory extends AbstractGatewayFilterFactory<AuGatewayFilterFactory.PathesConfig> {

    @Autowired
    private JwtProperties jwtProperties;

    //4.通过构造方法指定接收参数的对象类型
    public AuGatewayFilterFactory() {
        super(AuGatewayFilterFactory.PathesConfig.class);
    }
     ...
     */
    @Override
    public GatewayFilter apply(AuGatewayFilterFactory.PathesConfig config) {
        // 实现GatewayFilter接口
